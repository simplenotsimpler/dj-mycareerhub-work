...
from common.utils import AdminMediaMixin, FormOverridesMixin, ListDisplayMixin, register_current_app_models
...
@admin.register(Job)
class JobAdmin(FormOverridesMixin, AdminMediaMixin, ListDisplayMixin, admin.ModelAdmin):
    fieldsets = (
        (None, {
            "fields": (
...
class EducationAdmin(FormOverridesMixin, AdminMediaMixin, ListDisplayMixin, admin.ModelAdmin):
    fieldsets = (
        (None, {
            "fields": (
                ('institution'),
